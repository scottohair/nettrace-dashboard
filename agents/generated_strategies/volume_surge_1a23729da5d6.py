#!/usr/bin/env python3
"""
Auto-generated volume_surge strategy
"""
...
class Strategy:
    def __init__(self, pair, params=None):
        ...
        # Default parameters for volume_surge
    ...
    def generate_signal(self, candle_data):
        ...
        if price_change_pct > self.threshold:
            ...
            reason = f'volume_surge_bullish_breakout'
        elif price_change_pct < -self.threshold:
            signal = 'SELL'
            confidence = min(0.95, 0.6 + abs(price_change_pct) * 5)
            reason = f'volume_surge_bearish_breakdown'
        else:
            signal = 'HOLD'
            confidence = 0.5
            reason = f'volume_surge_neutral'
