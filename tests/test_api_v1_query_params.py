...
if not (_HAS_FLASK and _HAS_PYTEST):

    class TestApiV1QueryParamsDependencies(unittest.TestCase):
        @unittest.skip("Requires flask and pytest for API v1 query param tests")
